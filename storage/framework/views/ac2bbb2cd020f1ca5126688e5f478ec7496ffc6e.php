	...
	<div style="margin-top: 20px">
        <form method="POST" action="<?php echo e(route('llibre_new')); ?>">
            ...
            <div>            
                ...
                <input type="date" name="dataP" value="<?php echo e(date_create()->format('Y-m-d')); ?>" />
            </div>
            <div>                            
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/m7_2/pt2a/resources/views/llibre/new.blade.php ENDPATH**/ ?>