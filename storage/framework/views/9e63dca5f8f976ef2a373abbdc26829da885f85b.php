<?php $__env->startSection('title', 'Editar Llibre'); ?>
            ...
            <div>
                ...
                <select name="autor_id">
                    <?php $__currentLoopData = $autors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $autor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($autor->id); ?>" <?php if($llibre->autor_id == $autor->id): echo 'selected'; endif; ?>><?php echo e($autor->nomCognoms()); ?></option>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/m7_2/pt2a/resources/views/llibre/edit.blade.php ENDPATH**/ ?>